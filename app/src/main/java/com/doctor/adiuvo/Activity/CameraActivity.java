...
public class CameraActivity extends AppCompatActivity implements ImageAnalysis.Analyzer, View.OnClickListener {
    ...
    private ImageView bRecord,flashlightButton,imgSwipeCamera,gallary,closeImg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerTextView = findViewById(R.id.textCounter);
        ...
        bCapture = findViewById(R.id.imgCapture);
        gallary = findViewById(R.id.gallary_img);
        closeImg = findViewById(R.id.close_img);

        bRecord = findViewById(R.id.vedCapture);
        ...
        cameraProviderFuture.addListener(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    camera = cameraProvider.bindToLifecycle((LifecycleOwner) CameraActivity.this, cameraSelector);
            ...
            if (camera != null) {
                ...
                if (cameraInfo.hasFlashUnit()) {
                    if (isFlashlightOn) {
                        ...
                        flashlightButton.setImageDrawable(getDrawable(R.drawable.ic_flash_off));
                        camera.getCameraControl().enableTorch(false);
                        isFlashlightOn = false;
                    } else {
                        // Turn on the flashlight
                        flashlightButton.setImageDrawable(getDrawable(R.drawable.ic_flash_on));
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.imgCapture) {
            ...
            switchCamera();
            Toast.makeText(CameraActivity.this, "Failed to retrieve saved photo URI.", Toast.LENGTH_SHORT).show();


        } if (view.getId() == R.id.flashlightButton) {
            toggleFlashlight();

        } if (view.getId() == R.id.gallary_img) {
            Intent mIntent = new Intent(CameraActivity.this, GalleryActivity.class);
